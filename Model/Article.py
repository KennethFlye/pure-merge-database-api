...
class Article:
    ...
    def __init__(self, id, submitter, submitter_is_preferred, authors, authors_is_preferred, title, title_is_preferred, comments, comments_is_preferred, journalRef, journalRef_is_preferred, doi, doi_is_preferred, reportNumber, reportNumber_is_preferred, categories, categories_is_preferred, license, license_is_preffered, abstract, abstract_is_preferred, versions, versions_is_preferred, updateDate, updateDate_is_preferred, authorsParsed, authorsParsed_is_preferred, group):
        self.id = id
        ...
        self.license_is_preffered = license_is_preffered
        ...
        self.authorsParsed_is_preferred = authorsParsed_is_preferred
        self.group = group
