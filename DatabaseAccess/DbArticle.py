    ...
    def insert_article(self, article):
        with pgres.connect(host=config("HOST"), dbname=config("DATABASE"), user=config("USER"), password=config("PASSWORD")) as connection:
            ...
            cursor.execute(self.InsertArticleQuery,
                           {'submitter': article.submitter, 'submitter_is_preferred': article.submitter_is_preferred,
                            'authors_is_preferred': article.authors_is_preferred, 'title': article.title,
                            'title_is_preferred': article.title_is_preferred,
                            'comments_is_preferred': article.comments_is_preferred, 'journal_ref': article.journal_ref,
                            'journal_ref_is_preferred': article.journal_ref_is_preferred, 'doi': article.doi,
                            'doi_is_preferred': article.doi_is_preferred, 'report_number': article.report_number,
